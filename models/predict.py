...
class Predict:
    def __init__(self, video_path):
        ...
        parser.add_argument('--labels', type=str, default='./models/output_labels.txt')
        self.args = parser.parse_args()

        self.video_path = video_path

    def load_openPose(self, args):
    ...
    def load_label(self, args):
        ...
        return human_action_detection

    def video_and_predict(self, v_path, args, e, w, h, human_action_detection):
        # 비디오의 첫 프레임 읽기
